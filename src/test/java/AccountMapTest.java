...
public class AccountMapTest {
    ...
    public void setAccountsTest(){
        ...
        accounts.put(1, new Account(100.00, 1));
        accounts.put(1, new Account(200.00, 2));
        accounts.put(1, new Account(300.00, 3));

        AccountMap accountMap = new AccountMap();

        accountMap.setAccounts(accounts);
        Map<Integer, Account> actual = accountMap.getAccounts();
